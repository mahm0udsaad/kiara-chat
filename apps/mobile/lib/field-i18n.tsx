...
const arabic = {
  ...
  stepDriverArrived: "الوصول للأخصائية",
  ...
  noServices: "لا توجد خدمات مرتبطة بهذا الطلب.",
  appointment: "الموعد",
  ...
  completionResultTitle: "نتيجة الخدمة",
  completionResultBody: "اختاري هل تم تنفيذ الخدمة، وأضيفي ملاحظة لو في حاجة لازم الإدارة تراجعها.",
  completedAsPlanned: "تم التنفيذ",
  notCompleted: "لم يتم التنفيذ",
  completionNoteLabel: "ملاحظة (اختياري)",
  completionNotePlaceholder: "مثال: العميلة طلبت تغيير الخدمة أو حصلت مشكلة",
...
const english: Dictionary = {
  ...
  stepConfirmRide: "Confirm trip", stepDriverArrived: "Arrive at specialist", stepPickup: "Specialist pickup", stepStartService: "Start service",
  ...
  waitingNextStep: "Waiting for the next step", orderDetailsSection: "Order details", servicesSection: "Required services",
  noServices: "No services are linked to this order.", appointment: "Appointment time",
  ...
  completionResultTitle: "Service result", completionResultBody: "Choose whether the service was completed and add a note if management should review anything.",
...
const indonesian: Dictionary = {
  ...
  stepConfirmRide: "Konfirmasi perjalanan", stepDriverArrived: "Tiba di spesialis", stepPickup: "Penjemputan spesialis", stepStartService: "Mulai layanan",
  ...
  waitingNextStep: "Menunggu langkah berikutnya", orderDetailsSection: "Rincian pesanan", servicesSection: "Layanan yang diperlukan",
  noServices: "Tidak ada layanan yang terhubung ke pesanan ini.", appointment: "Waktu janji",
  ...
  completionResultTitle: "Hasil layanan", completionResultBody: "Pilih apakah layanan selesai dan tambahkan catatan jika manajemen perlu meninjau sesuatu.",
...
const filipino: Dictionary = {
  ...
  stepConfirmRide: "Kumpirmahin ang biyahe", stepDriverArrived: "Dumating sa specialist", stepPickup: "Pagsakay ng specialist", stepStartService: "Simulan ang serbisyo",
  ...
  waitingNextStep: "Naghihintay sa susunod na hakbang", orderDetailsSection: "Detalye ng order", servicesSection: "Mga kinakailangang serbisyo",
  noServices: "Walang serbisyong nakaugnay sa order na ito.", appointment: "Oras ng appointment",
  ...
  completionResultTitle: "Resulta ng serbisyo", completionResultBody: "Piliin kung natapos ang serbisyo at magdagdag ng tala kung may kailangang suriin ang management.",
...
const russian: Dictionary = {
  ...
  stepConfirmRide: "Поездка подтверждена", stepDriverArrived: "Прибытие к специалисту", stepPickup: "Специалист в машине", stepStartService: "Начало услуги",
  ...
  servicesSection: "Необходимые услуги", noServices: "К этому заказу не привязаны услуги.",
  ...
  completionResultTitle: "Результат услуги", completionResultBody: "Укажите, выполнена ли услуга, и добавьте заметку, если руководству нужно что-то проверить.",
...
const amharic: Dictionary = {
  ...
  stepConfirmRide: "ጉዞውን አረጋግጥ", stepDriverArrived: "ወደ ባለሙያዋ ደረሰ", stepPickup: "ባለሙያዋ ተሳፍራለች", stepStartService: "አገልግሎት ጀምር",
  ...
  waitingNextStep: "ቀጣዩን ደረጃ በመጠበቅ ላይ", orderDetailsSection: "የትዕዛዝ ዝርዝር", servicesSection: "የሚፈለጉ አገልግሎቶች",
  noServices: "ከዚህ ትዕዛዝ ጋር የተገናኘ አገልግሎት የለም።", appointment: "የቀጠሮ ሰዓት",
  ...
  completionResultTitle: "የአገልግሎት ውጤት", completionResultBody: "አገልግሎቱ መጠናቀቁን ይምረጡ፣ አስተዳደሩ የሚመረምረው ነገር ካለም ማስታወሻ ያክሉ።",
